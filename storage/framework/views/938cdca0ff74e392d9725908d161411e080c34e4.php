        ...
        <div class="container">
            <div class="mu-header-area">
                ...
                <div class="mu-logo-area">
                    ...
                    <a class="mu-logo" href="#">LaraTasks</a>
                ...
                <div class="mu-header-featured-area">
                    ...
                    <div class="mu-header-featured-content">
                        <h1>Welcome To <span>LaraTasks</span></h1>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mu-feature-content-left">
                                        <img class="mu-profile-img" src="/images/second.png" alt="Another Image">
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<footer id="mu-footer" role="contentinfo">
    <div class="container">
        <div class="mu-footer-area">
            <p class="mu-copy-right">&copy; Copyright <a rel="nofollow" href="http://laratasks.co.uk">laratasks.co.uk</a>. All right reserved.</p>
        </div>
    </div>
