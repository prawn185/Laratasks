    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <a href="{{URL::to('tasks/create', $user->id)}}"><div class="btn btn-success">Create Task <i class="fa fa-plus" aria-hidden="true"></i></div></a>
                ...
                <div class="col-lg-12">
                    @if(count($tasks) == 0)
                        <div class="alert alert-danger" role="alert">
                            You have no tasks click "<a href="{{URL::to('tasks/create', $user->id)}}">Create New</a>" to start your task list!
                        </div>
                    @endif
